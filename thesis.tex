...
\begin{document}
	...
	\chapter{Methodology}
		...
		\section{Coordinate Transform}
			As the utilized spatial discretization, given by the mesh in figure \ref{fig:mesh}, inherits rotational symmetry, the coordinate transform from Cartesian to cylinder coordinates is beneficial.
