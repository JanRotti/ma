	...
	\chapter{Results and Discussion}
		...
		\section{Optimal Model} %reconstruction error
			\subsection{POD Activation}
				Projecting the POD modes from \ref{sec:solpod} onto the simulation snapshots gives rise to the optimal POD model. The optimal POD model is characterized by the periodic activation of modes, which can be computed as described in equation \ref{eq:podactcalc}. The optimal activations are computed for the first eight eigenmodes of each dataset, depicted in \ref{fig:podactiv0.01},\ref{fig:podactiv0.1},\ref{fig:podactiv0.6} and serve as comparison for the reduced order model.		
				Note the temporal shift of the complementary modes, the increase in frequency and the decrease in amplitude as the mode number increases.
...
\appendix
	...
	\begin{figure}[hbt]
		\begin{subfigure}{0.45\textwidth}
			\centering
			\includegraphics[width=\linewidth]{mach_0.01/POD_Eigenvalues_0.01.png}
			\caption{Eigenvalues for POD decomposition for dataset with mach $0.01$}
		\end{subfigure}
		\quad
		\begin{subfigure}{0.45\textwidth}
			\centering
			\includegraphics[width=\linewidth]{mach_0.1/POD_Eigenvalues_0.1.png}
		...
		\begin{subfigure}{0.45\textwidth}
			\centering
			\includegraphics[width=\linewidth]{mach_0.6/POD_Eigenvalues_0.6.png}
