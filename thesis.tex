...
\begin{document}
	...
	\chapter{Results and Discussion}
		...
		\section{Optimal Model}
			Projecting the POD modes from \ref{sec:solpod} onto the simulation snapshots gives rise to the optimal pod model. The optimal POD model is characterized by the periodic activation of modes. The optimal activations can be computed as described in equation \ref{eq:podactcalc}. The optimal activations are computed for the first eight eigenmodes of each dataset.  
		\section{POD ROM}
